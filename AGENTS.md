# Zettel agent context

Read README.md and docs/product-research.md. Follow the shared [portfolio context](https://github.com/zinnoberHaus/zinnober-haus/blob/main/AGENTS.md) and governance, while keeping product decisions here.
